      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
              ...
              <div className="bg-gradient-to-r from-green-900/40 to-blue-900/40 rounded-2xl p-8 text-center border-2 border-yellow-500/50">
                ...
                <div className="space-y-4">
                  <UnifiedCheckoutButton
                    ...
                    className="w-full bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-500 hover:to-emerald-600 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-2xl text-lg"
                    variant="direct"
                  />
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-gray-800/40 rounded-xl p-6 text-center border border-emerald-500/50 hover:border-emerald-500/70 transition-colors">
            ...
            <div className="bg-gray-800/40 rounded-xl p-6 text-center border border-blue-500/50 hover:border-blue-500/70 transition-colors">
            ...
            <div className="bg-gray-800/40 rounded-xl p-6 text-center border border-purple-500/50 hover:border-purple-500/70 transition-colors">
