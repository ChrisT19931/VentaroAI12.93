          ...
          <div className="md:flex">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="mt-1 form-input transition-all duration-300 transform focus:scale-[1.01]"
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="mt-1 form-select transition-all duration-300 transform focus:scale-[1.01]"
                      >
                  ...
                  <div>
                    <button
                      ...
                      className="form-submit w-full py-3 px-6 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium rounded-lg shadow-lg flex justify-center items-center transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                    >
                      {isSubmitting ? (
                        <>
            ...
            <div className="md:w-1/2 bg-primary-600 p-8 text-white">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2">What is your payment structure for custom web development?</h3>
                  <p className="text-primary-100">
                    Custom web development projects require a 50% upfront payment to begin work, with the remaining 50% due upon completion. We guarantee 21-day delivery - if not completed in 21 days, we continue building but only keep the upfront payment (no additional charges). All payments are final and non-refundable once work has commenced.
                  </p>
                </div>
                <div>
