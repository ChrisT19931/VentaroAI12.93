        ...
        <div className="bg-gradient-to-r from-cyan-900/50 to-blue-900/50 rounded-2xl p-8 mb-12 border border-cyan-500/30">
          <div className="flex items-center justify-between">
            ...
            <a
              ...
              download
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold text-lg rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
        ...
        <div className="mb-12">
          ...
          <div className="grid gap-6">
            {samplePrompts.map((prompt) => (
              <div key={prompt.id} className="bg-gray-900/60 rounded-2xl p-6 border border-gray-700">
          ...
          <div className="bg-gray-900/60 rounded-2xl p-8 border border-gray-700">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-cyan-400 font-semibold">75+ prompts</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-white">Marketing & Sales</span>
                <span className="text-cyan-400 font-semibold">120+ prompts</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-white">Content Creation</span>
                <span className="text-cyan-400 font-semibold">100+ prompts</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-white">Customer Service</span>
                <span className="text-cyan-400 font-semibold">60+ prompts</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-white">Product Development</span>
                <span className="text-cyan-400 font-semibold">50+ prompts</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-white">Financial Planning</span>
                <span className="text-cyan-400 font-semibold">40+ prompts</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-white">Operations & Automation</span>
                <span className="text-cyan-400 font-semibold">55+ prompts</span>
              </div>
            </div>
          </div>
