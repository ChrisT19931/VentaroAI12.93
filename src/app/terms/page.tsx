        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 mb-8">
          <div className="prose max-w-none">
            ...
            <p className="mb-4 text-gray-800">
              Welcome to Ventaro AI, a Melbourne-based company founded in March 2025. These Terms & Conditions ("Terms") govern your access to and use of our website, digital products, and services including VAI Coaching, VAI Masterclass, VAI Toolkit, and VAI Web Gen. By accessing or using our services, you agree to be bound by these Terms.
            </p>
            <p className="mb-4 text-gray-800">
            ...
            <div className="bg-blue-50 border border-blue-300 rounded-lg p-4 mb-4">
              <h3 className="text-xl font-bold text-black mb-2">Custom Web Development Payment Terms</h3>
              <p className="text-gray-800 mb-2">
                For custom web development projects, our payment structure is as follows:
              </p>
              <ul className="list-disc pl-6 mt-2 text-gray-800">
                <li><strong>50% upfront payment</strong> required to commence project work</li>
                <li><strong>Remaining 50% due upon project completion</strong> and delivery</li>
                <li><strong>21-day delivery guarantee</strong> - If project is not completed within 21 days, we continue building but only keep the 50% upfront payment (no additional charges)</li>
                <li><strong>No refunds on upfront payments</strong> once project work has begun</li>
                <li><strong>All payments are final</strong> regardless of project status</li>
              </ul>
              <p className="text-gray-800 mt-2">
            ...
            <p className="mb-4 text-gray-800">
              These Terms and your use of our services shall be governed by and construed in accordance with the laws of Victoria, Australia, without giving effect to any choice or conflict of law provision or rule. Any disputes arising from these Terms or your use of our services shall be subject to the exclusive jurisdiction of the courts of Melbourne, Victoria, Australia.
            </p>
            <p className="mb-4 text-gray-800">
              Our services comply with Australian Consumer Law (ACL) and the Competition and Consumer Act 2010. Nothing in these Terms excludes, restricts or modifies any consumer guarantees, warranties, rights or remedies that you may have under the ACL or any other applicable law which cannot be excluded, restricted or modified by agreement.
            </p>
