      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="glass-panel rounded-xl p-6 sm:p-8 md:p-10 border border-purple-500/30 mt-12 sm:mt-16 md:mt-20">
          ...
          <div className="flex justify-center">
            <Link href="/products/1" className="inline-block bg-gradient-to-r from-purple-600 to-purple-500 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-lg hover:opacity-90 transition-all duration-300 text-sm sm:text-base md:text-lg">
